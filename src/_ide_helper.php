...
namespace Orangehill\Iseed\Facades {
    ...
    class Iseed {
         ...
         * @static
         */
        public static function generateSeed($table, $prefix = null, $suffix = null, $database = null, $max = 0, $chunkSize = 0, $exclude = null, $prerunEvent = null, $postrunEvent = null, $dumpAuto = true, $indexed = true, $orderBy = null, $direction = 'ASC', $whereClause = null, $register = true, $skipFkChecks = false, $skip = null)
        {
            /** @var \Orangehill\Iseed\Iseed $instance */
            return $instance->generateSeed($table, $prefix, $suffix, $database, $max, $chunkSize, $exclude, $prerunEvent, $postrunEvent, $dumpAuto, $indexed, $orderBy, $direction, $whereClause, $register, $skipFkChecks, $skip);
        }
         ...
         * @static
         */
        public static function populateStub($class, $stub, $table, $data, $chunkSize = null, $prerunEvent = null, $postrunEvent = null, $indexed = true, $database = null, $skipFkChecks = false)
        {
            /** @var \Orangehill\Iseed\Iseed $instance */
            return $instance->populateStub($class, $stub, $table, $data, $chunkSize, $prerunEvent, $postrunEvent, $indexed, $database, $skipFkChecks);
        }
