...
@section ('content')
    ...
    <div class="container pt-1">
                    ...
                    <div id="navbar" class="navbar-collapse collapse justify-content-md-center mb-3">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item" style="font-size:15px; font-weight:bold;"><a class="nav-link"
                                                                                              href="#event">@lang('events.eventinfo')</a>
                            </li>
                            <li class="nav-item" style="font-size:15px; font-weight:bold;"><a class="nav-link"
                                                                                              href="#server">@lang('events.server')</a>
                            </li>
                            <li class="nav-item" style="font-size:15px; font-weight:bold;"><a class="nav-link"
                            ...
                            @if (!$event->tournaments->isEmpty())
                                <li class="nav-item" style="font-size:15px; font-weight:bold;"><a class="nav-link"
                                                                                                  href="#tournaments">@lang('events.tournaments')</a>
                                </li>
                            @endif
                            @if ($event->matchmaking_enabled && $isMatchMakingEnabled)
                                <li class="nav-item" style="font-size:15px; font-weight:bold;"><a class="nav-link"
                                                                                                  href="#matchmaking">@lang('matchmaking.matchmaking')</a>
                                </li>
                            @endif
                            <li class="nav-item" style="font-size:15px; font-weight:bold;"><a class="nav-link"
                                                                                              href="#information">@lang('events.essentialinfo')</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                @if (Settings::getTeamspeakLink() != "")
                    <div class="col-6 col-lg-4">
                        <a href="ts3server://{{ Settings::getTeamspeakLink() }}?nickname={{ $user->username }}"><i
                                    class="fab fa-teamspeak fa-2x margin"></i>@lang('home.servers_teamspeak')</a>
                    </div>
                @endif

                @if (Settings::getMumbleLink() != "")
                    <div class="col-6 col-lg-4">
                        <a href="mumble://{{ $user->username }}{{ chr(64) }}{{ Settings::getMumbleLink() }}"
                           width="100%">
                            <img class="margin" src="https://www.mumble.info/css/mumble.svg" alt="Mumble Logo"
                                 width="28" height="28">@lang('home.servers_mumble')
                        </a>
                    </div>
                @endif
                @if (Settings::getFacebookLink() != "")
                    <div class="col-6 col-lg-4">
                        <a target="_blank" rel="noreferrer" href="{{ Settings::getFacebookLink() }}"><i
                                    class="fab fa-facebook fa-2x margin"></i>@lang('home.servers_facebook')</a>
                    </div>
                @endif
                @if (Settings::getDiscordLink() != "")
                    <div class="col-6 col-lg-4">
                        <a target="_blank" rel="noreferrer" href="{{ Settings::getDiscordLink() }}"><i
                                    class="fab fa-discord fa-2x margin"></i>@lang('home.servers_discord')</a>
                    </div>
                @endif
                @if (Settings::getSteamLink() != "")
                    <div class="col-6 col-lg-4">
                        <a target="_blank" rel="noreferrer" href="{{ Settings::getSteamLink() }}"><i
                                    class="fab fa-steam fa-2x margin"></i>@lang('home.servers_steam')</a>
                    </div>
                @endif
                @if (Settings::getRedditLink() != "")
                    <div class="col-6 col-lg-4">
                        <a target="_blank" rel="noreferrer" href="{{ Settings::getRedditLink() }}"><i
                                    class="fab fa-reddit fa-2x margin"></i>@lang('home.servers_reddit')</a>
                    </div>
                @endif
                @if (Settings::getTwitterLink() != "")
                    <div class="col-6 col-lg-4">
                        <a target="_blank" rel="noreferrer" href="{{ Settings::getTwitterLink() }}"><i
                                    class="fab fa-twitter fa-2x margin"></i>@lang('home.servers_twitter')</a>
                    </div>
                @endif
            </div>
                            ...
                            <div class="card mb-3">
                                <div class="card-header ">
                                    <div class="row text-center block-center">
                                        <picture>
                                            <source srcset="{{ $gameServers[0]->game->image_thumbnail_path }}.webp"
                                                    type="image/webp">
                                            <source srcset="{{ $gameServers[0]->game->image_thumbnail_path }}"
                                                    type="image/jpeg">
                                            <img src="{{ $gameServers[0]->game->image_thumbnail_path }}"
                                                 class="img img-fluid rounded img-contain margin-top margin-bottom width=100em"
                                                 height="100em">
                                        </picture>
                                    ...
                                    @foreach ($gameServers as $gameServer)
                                        ...
                                        @if($gameServer->game->gamecommandhandler != "0")
                                            <div id="serverstatus_{{ $gameServer->id }}">
                                                <div>
                                                    <i class="fas fa-map-marked-alt margin"></i><strong>Map: </strong><span
                                                            id="serverstatus_{{ $gameServer->id }}_map">Waiting for status</span>
                                                </div>
                                                <div><i class="fas fa-users margin"></i><strong>Players: </strong><span
                                                            id="serverstatus_{{ $gameServer->id }}_players">Waiting for status</span>
                                                </div>
                                            </div>
                                        @else
                                            <div id="serverstatus_{{ $gameServer->id }}">
                                                <div>
                                                    <span id="serverstatus_{{ $gameServer->id }}_nostats">No Status</span>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        @if($gameServer->game->connect_game_url || $gameServer->game->connect_game_command )
                                            @if($gameServer->game->connect_game_url)
                                                <a class="btn btn-primary btn-block" id="connectGameUrl"
                                                   href="{{ Helpers::resolveServerCommandParameters($gameServer->game->connect_game_url, NULL, $availableParameters) }}"
                                                   role="button">Join Game</a>
                                            @endif
                                            @if($gameServer->game->connect_game_command)
                                                <div class="input-group" style="width: 100%">
                                                    <input class="form-control"
                                                           id="connectGameCommand{{ $availableParameters->gameServer->id }}"
                                                           type="text" readonly
                                                           value="{{ Helpers::resolveServerCommandParameters($gameServer->game->connect_game_command, NULL, $availableParameters) }}">
                                                    <span class="input-group-btn">
							<button class="btn btn-primary" type="button"
                                    onclick="copyToClipBoard('connectGameCommand{{$availableParameters->gameServer->id}}')"><i
                                        ...
                                        @else
                                            @if($gameServer->address)
                                                <div><strong>IP: </strong><span
                                                            id="serverip_{{ $gameServer->id }}">{{$gameServer->address}}</span>
                                                </div>
                                            @endif
                                            @if($gameServer->game_port)
                                                <div><strong>Port: </strong><span
                                                            id="serverip_{{ $gameServer->id }}">{{$gameServer->game_port}}</span>
                                                </div>
                                            @endif
                                            @if($gameServer->game_password)
                                                <div><strong>Password: </strong><span
                                                            id="serverpw_{{ $gameServer->id }}">{{$gameServer->game_password}}</span>
                                                </div>
                                            @endif
                                        @endif
                                        ...
                                        @if($gameServer->game->connect_stream_url && $gameServer->stream_port != 0)
                                            <a class="btn btn-primary btn-block"
                                               href="{{ Helpers::resolveServerCommandParameters($gameServer->game->connect_stream_url, NULL, $availableParameters) }}"
                                               role="button">Join Stream</a>
                                        @endif
                                    @endforeach
                                </div>
                            </div>
                               ...
                               class="link-unstyled">
                                <div class="card card-hover mb-3">
                                    @if ($tournament->game && $tournament->game->image_thumbnail_path)
                                        <picture>
                                            <source srcset="{{ $tournament->game->image_thumbnail_path }}.webp"
                                                    type="image/webp">
                                            <source srcset="{{ $tournament->game->image_thumbnail_path }}"
                                                    type="image/jpeg">
                                            <img class="img img-fluid rounded"
                                                 src="{{ $tournament->game->image_thumbnail_path }}"
                                                 alt="{{ $tournament->game->name }}" class="card-img-top img-fluid">
                                        </picture>
                                    @endif
                                    <div class="card-body">
        ...
        @if ($event->matchmaking_enabled && $isMatchMakingEnabled)
                ...
                <div class="row">
                    ...
                    <div class="col-sm mt-4">
                        @if(Settings::getSystemsMatchMakingMaxopenperuser() == 0 || count($currentUserOpenLivePendingDraftMatches) < Settings::getSystemsMatchMakingMaxopenperuser())
                            <a href="/matchmaking/" class="btn btn-success btn-sm btn-block float-end"
                               data-bs-toggle="modal" data-bs-target="#addMatchModal">Add Match</a>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="modal fade" id="addMatchModal" tabindex="-1" role="dialog" aria-labelledby="addMatchModal"
                 aria-hidden="true">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        {{ Form::checkbox('ispublic', null, null, array('id'=>'ispublic')) }} is public
                                        (show match publicly for signup)
                                    </label>
                                </div>
                            </div>
        ...
        <table class="table table-striped">
            ...
            @foreach ($event->tickets as $ticket)
                <tr>
                    <td>
                        <img class="img-fluid rounded" style="max-width: 70%;"
                             alt="{{ $ticket->user->username }}'s Avatar" src="{{ $ticket->user->avatar }}">
                    </td>
        ...
        in_array('PREVIEW', $event->seatingPlans->pluck('status')->toArray())
            ...
            <div class="pb-2 mt-4 mb-4 border-bottom">
                <a name="seating"></a>
                <h3><i class="fas fa-chair me-3"></i>@lang('events.seatingplans')
                    <small>- {{ $event->getSeatingCapacity() - $event->getSeatedCount() }}
                        / {{ $event->getSeatingCapacity() }} @lang('events.seatsremaining')</small></h3>
            </div>
                    ...
                    @if ($seatingPlan->status != 'DRAFT')
                        <div class="card mb-3">
                            <a class="collapsed" role="button" data-bs-toggle="collapse" data-parent="#accordion"
                               href="#collapse_{{ $seatingPlan->slug }}" aria-expanded="true"
                               aria-controls="collapse_{{ $seatingPlan->slug }}">
                                <div class="card-header  bg-success-light" role="tab" id="headingOne">
                                    <h4 class="card-title m-0">
                                        {{ $seatingPlan->name }}
                                        <small>- {{ $seatingPlan->getSeatingCapacity() - $seatingPlan->getSeatedCount() }}
                                            / {{ $seatingPlan->getSeatingCapacity() }} @lang('events.available')</small>
                            ...
                            <div id="collapse_{{ $seatingPlan->slug }}" class="collapse @if ($loop->first) in @endif"
                                 role="tabpanel" aria-labelledby="collaspe_{{ $seatingPlan->slug }}">
                                <div class="card-body">
                                    <div class="table-responsive text-center">
                                        <table class="table">
                                            ...
                                            @for ($row = 1; $row <= $seatingPlan->rows; $row++)
                                                <tr>
                                                    <td>
                                                        <h4>
                                                            <strong>{{ Helpers::getLatinAlphabetUpperLetterByIndex($row) }}</strong>
                                                        </h4>
                                                    </td>
                                        ...
                                        @if ($seatingPlan->locked)
                                            <p class="text-center"><strong> @lang('events.seatingplanlocked')</strong>
                                            </p>
                                        @endif
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="row" style="display: flex; align-items: center;">
                                        <div class="col-12 col-md-8">
                                            <img class="img-fluid" alt="{{ $seatingPlan->name }}"
                                                 src="{{$seatingPlan->image_path}}"/>
                                        </div>
        ...
        <!-- Seat Modal -->
        <div class="modal fade" id="pickSeatModal" tabindex="-1" role="dialog" aria-labelledby="editSeatingModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    @if (Auth::user())
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-danger"
                                    data-bs-dismiss="modal">@lang('events.no')</button>
                        </div>
                        {{ Form::close() }}
                    @endif
                </div>
